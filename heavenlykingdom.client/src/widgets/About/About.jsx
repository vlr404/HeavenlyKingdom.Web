    ...
    export const About = () => {
        return (
            <section id="About" className="About">
                ...
                <Benefits />
                <Space mt="100" />
                <QuoteBlock title="ПОСЕТИТЬ ЦЕРКОВЬ" quote="Пріидите, возрадуемся Господеви, воскликнемъ Богу Спасителю нашему: предваримъ в лице Его во исповѣданіи, и во псалмѣхъ воскликнемъ Ему. Яко Богъ Велій Господь, и Царь Велій по всей земли." backgr_img= "./public/foto/deva-mariya.png"/>
            </section>
        );
    };